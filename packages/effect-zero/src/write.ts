...
import type { CodeBlockWriter, Project } from "ts-morph";
...
const writeColumn = (writer: CodeBlockWriter, column: InferredColumn, indent = 4) => {
  ...
  writer.newLine();
  writer.write(`${indentString}customType: customType<${column.customType}>()`);
...
export const getGeneratedSchema = ({
  ...
  sourceFile.addFunction({
    ...
    returnType: "T",
    statements: ["return null as unknown as T;"],
  });
