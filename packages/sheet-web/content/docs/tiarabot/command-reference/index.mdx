...
These commands store TiaraBot's channel mapping. They do not change Discord channel permission overwrites. If a lockdown role is configured, TiaraBot needs Manage Roles and its bot role must sit above that role.
