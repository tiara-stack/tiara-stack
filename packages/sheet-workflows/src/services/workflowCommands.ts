...
import {
  isTeamSubmissionsSheetWorkflowName,
  materializeTeamSubmissionsWorkflowFailure,
...
import {
  isMemberSheetWorkflowName,
  materializeMemberWorkflowFailure,
...
const dispatchWorkflowSlices: ReadonlyArray<DispatchWorkflowSlice> = [
  ...
  {
    isWorkflowName: isCheckinSheetWorkflowName,
    definitionVersion: checkinSheetWorkflowDefinitionVersion,
    materializeFailure: materializeCheckinWorkflowFailure,
  },
  {
    isWorkflowName: isCalculationSheetWorkflowName,
    definitionVersion: calculationSheetWorkflowDefinitionVersion,
    materializeFailure: materializeCalculationWorkflowFailure,
  },
  {
    isWorkflowName: isTeamSubmissionsSheetWorkflowName,
    definitionVersion: teamSubmissionsSheetWorkflowDefinitionVersion,
    materializeFailure: materializeTeamSubmissionsWorkflowFailure,
  },
  {
    isWorkflowName: isMemberSheetWorkflowName,
