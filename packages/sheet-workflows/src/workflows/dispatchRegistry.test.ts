...
const makeDispatchServiceMock = (overrides: Partial<DispatchServiceMock>): DispatchServiceMock => ({
  ...
  workspaceSetMonitorChannel: unexpectedDispatchServiceCall("workspaceSetMonitorChannel"),
  workspaceUnsetMonitorChannel: unexpectedDispatchServiceCall("workspaceUnsetMonitorChannel"),
  ...
  it.live("requires manage-workspace authorization snapshots for config mutation workflows", () =>
    Effect.gen(function* () {
      ...
      const cases = [
        ...
        (currentAuthorization: typeof authorization) =>
          dispatchWorkflowRegistry.workspaceSetMonitorChannel.authorize({
            requester,
            authorization: currentAuthorization,
            payload: {
              client: discordClient,
        ...
        (currentAuthorization: typeof authorization) =>
          dispatchWorkflowRegistry.workspaceUnsetMonitorChannel.authorize({
            requester,
            authorization: currentAuthorization,
            payload: {
              client: discordClient,
