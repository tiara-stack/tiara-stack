...
export default Effect.gen(function* () {
  ...
  yield* sql.unsafe(
    `alter table "sheet_db_config_workspace_sheet" add column "baseline_digest" varchar`,
  ).withoutTransform;
  ...
  "public"."sheet_db_config_workspace_sheet" ("active_revision_id", "base_revision_id", "baseline_digest", "created_at", "deleted_at", "diagnostics", "draft", "draft_version", "source", "updated_at", "updated_by", "workspace_id"),
