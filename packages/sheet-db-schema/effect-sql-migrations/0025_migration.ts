...
export default Effect.gen(function* () {
  ...
  yield* sql.unsafe(
    `alter table "sheet_db_config_workspace" add column "announcement_conversation_id" varchar`,
  ).withoutTransform;
  ...
  "public"."sheet_db_config_workspace" ("announcement_conversation_id", "auto_checkin", "created_at", "deleted_at", "monitor_conversation_id", "sheet_id", "updated_at", "workspace_id"),
  ...
  "public"."sheet_db_message_team_submission" ("client_id", "client_platform", "confirmation_message_id", "conversation_id", "created_at", "deleted_at", "discord_author_id", "discord_channel_id", "discord_guild_id", "message_id", "parsed_submission", "rollback_snapshot", "row_mappings", "sheet_configuration_binding", "sheet_id", "status", "updated_at", "version", "workspace_id"),
