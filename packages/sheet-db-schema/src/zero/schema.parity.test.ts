...
const expectedSchema = {
  tables: {
    ...
    configWorkspaceTeamSubmissionChannel: table(
      "configWorkspaceTeamSubmissionChannel",
      sheetDb("config_workspace_team_submission_channel"),
      ["workspaceId", "conversationId"],
      [
        ["workspaceId", "string", false, "workspace_id"],
        ["conversationId", "string", false, "conversation_id"],
        ["destinationTeamConfigName", "string", true, "destination_team_config_name"],
        ["writeMode", "string", false, "write_mode"],
        ["removedRowStrategy", "string", false, "removed_row_strategy"],
        ["requireValidOshi", "boolean", false, "require_valid_oshi"],
        ...auditColumns,
      ],
    ),
    ...
    messageTeamSubmission: table(
      "messageTeamSubmission",
      sheetDb("message_team_submission"),
      ...
      [
        ...
        ["clientPlatform", "string", false, "client_platform"],
        ["clientId", "string", false, "client_id"],
        ["discordGuildId", "string", false, "discord_guild_id"],
        ["discordChannelId", "string", false, "discord_channel_id"],
        ["discordAuthorId", "string", false, "discord_author_id"],
        ["sheetId", "string", false, "sheet_id"],
        ["confirmationMessageId", "string", true, "confirmation_message_id"],
        ["parsedSubmission", "json", false, "parsed_submission"],
        ["rollbackSnapshot", "json", true, "rollback_snapshot"],
        ["rowMappings", "json", false, "row_mappings"],
